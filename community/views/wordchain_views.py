...
def wordchain_create(request):
    ...
    if request.method == 'POST':
        ...
        if not first_word:
            ...
            return redirect('community:wordchain_list')
        ...
        try:
            with transaction.atomic():
                ...
                return redirect('community:wordchain_detail', game_id=game.id)
...
def wordchain_finish(request, game_id):
    ...
    if request.user != game.creator:
        ...
        return redirect('community:wordchain_detail', game_id=game_id)
